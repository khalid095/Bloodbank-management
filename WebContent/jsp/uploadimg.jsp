...
<div style="width: 100px;height: 100px;margin-left: 300px;margin-top:30px">
 <img src="/bloodbank/imgs/Untitled1.jpg">
</div>
<div style="width: 400px;height: 70px;color: red;margin-left: 200px;margin-top: 100px">
<form method="post" action="/bloodbank/UploadImg" enctype="multipart/form-data">
