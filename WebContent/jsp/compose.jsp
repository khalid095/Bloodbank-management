...
<form method="post" action="/bloodbank/Compose">
<table style="width: 60%;height: 60%;color: black;margin-left: 10%;margin-top: 10%;border: solid">
<tr><th>Receiverid</th><th><input type="text" name="txtrecid" id="txtrecid"></th></tr>
<tr>    <th>Subject</th><th><textarea name="txtsub" id="txtsub" rows="3" cols="20"></textarea></th> </tr>
<tr><th>Message</th><th><textarea name="txtmsg" id="txtmsg" rows="10" cols="20"></textarea></th></tr>

<tr><th colspan="2"><button type="submit">send</button></th></tr>
</table>
</form>
