...
<div style="width: 82%;height: 700px;background-color:crimson;float: left">
...
/* 
	...
	%>
	<table style="margin-left: 300px;margin-top: 20px;color: white" border="3">
		<tr>
